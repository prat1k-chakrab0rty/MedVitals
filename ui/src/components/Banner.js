  ...
  return (
    <Box sx={{ position: 'relative'}}>
      ...
      <img
        ...
        style={{
          position: 'absolute',
          top: '254px', // Adjust this value as needed
          right: '420px', // Adjust this value as needed
          width: '150px', // Set width to control size
          height: 'auto', // Maintain aspect ratio
          transform: 'scale(6.6)' // Optional scale for effect
        }}
        alt='doctor_with_laptop'
      />
      <Box sx={{
        position: 'absolute',
        top: '256px', // Adjust this value as needed
        ...
        <Button sx={{ mt: 1, backgroundColor: '#d81b60',py:"3px",fontSize:8,fontWeight:400,px:2.5, textTransform: 'none', color: '#ffffff' }}>Book Appointment Now</Button>
      </Box>
    </Box>
  )
}
